...
$lang['admin']['duplicity_backup_help'] = 'Backups using <a href="http://duplicity.nongnu.org/">Duplicity</a>.<br><i>Duplicity options</i> are duplicity flags that can be auto-applied to all backup commands.  default: <i>--full-if-older-than 1M</i> means it will perform a full backup (not incremental) each month.';
$lang['admin']['duplicity_enabled'] = 'Enable Backups?';
$lang['admin']['duplicity_dst'] = 'Destination path';
$lang['admin']['duplicity_options'] = 'Duplicity options';
...
$lang['admin']['duplicity_jobs_help'] = 'Jobs are expressed as ENVIRONMENT VARIABLES in this format:<br><b>JOB_100_WHAT:</b> backup-command<br><b>JOB_200_WHEN:</b> interval<br>At <i>interval(s)</i>, jobs are executed in order of Job ID number.  EG. JOB_200 will be executed before JOB_201. <br><b>TESTING:</b> You can manually run ALL scheduled jobs with the following command:<pre>docker-compose exec duplicity-backup ./test-backups.sh</pre>';
$lang['admin']['duplicity_job_add'] = 'Add Backup Job';
$lang['admin']['duplicity_job_add_help'] = 'Add a new job.  ID represents the order it runs in.  Command is the job to run.<br>Builtin commands:<br>backup = executes the default duplicity backup command.<br>mysql-backup = runs mysql-dump on the mysql-mailcow DB.<br>redis-backup = trigger redis to persist to its disk.';
...
$lang['admin']['duplicity_job_15min'] = '15 Min';
$lang['admin']['duplicity_job_hourly'] = 'Hourly';
$lang['admin']['duplicity_job_daily'] = 'Daily';
$lang['admin']['duplicity_job_weekly'] = 'Weekly';
$lang['admin']['duplicity_job_monthly'] = 'Monthly';
